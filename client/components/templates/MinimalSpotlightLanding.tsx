...
export default function MinimalSpotlightLanding({ brandName = "Your Institute" }: MinimalSpotlightLandingProps) {
    return (
        <div className="min-h-[calc(100vh-4rem)] -mx-2 md:-mx-4">
            ...
            <section className="relative rounded-2xl p-10 md:p-16 bg-white dark:bg-slate-800 border overflow-hidden">
            ...
            <footer id="contact" className="rounded-2xl border bg-white dark:bg-slate-800 p-6">
                <div className="grid md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <p className="text-sm text-slate-600 dark:text-slate-300">Minimal, distraction-free learning for focused progress.</p>
                    </div>
                    <div>
