...
export default function ValueProposition() {
  ...
  return (
      <section className="bg-gradient-to-b from-slate-50 to-white dark:from-slate-800 dark:to-slate-900 py-10 md:py-14">
                  ...
                  {features.map((item, index) => (
                      ...
                      >
                          <Card className="
                                          ...
                                          dark:shadow-[0_0_15px_rgba(15,23,42,0.6)] 
                                          dark:hover:shadow-[0_0_25px_rgba(15,23,42,0.8)]
                                          hover:-translate-y-2 
