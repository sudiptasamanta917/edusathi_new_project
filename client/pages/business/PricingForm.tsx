                                        ...
                                        <div className="space-y-6">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-slate-500 mt-1">
                                                    This will be your institute's student portal domain
                                                </p>
                                            </div>

                                            <div>
                                                <Label htmlFor="subdomainName">
                                                ...
                                                <Input
                                                    ...
                                                    onChange={(e) =>
                                                        handleInputChange("subdomainName", e.target.value)
                                                    }
                                                    placeholder="admin.your-institute.com"
                                                    className="mt-1"
                                                />
                                                <p className="text-xs text-slate-500 mt-1">
                                                    This will be your admin panel and management domain
                                                </p>
                                            </div>
