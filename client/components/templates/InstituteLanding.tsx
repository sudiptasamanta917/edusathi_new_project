...
export default function InstituteLanding({ brandName = "Your Institute" }: InstituteLandingProps) {
    return (
        <div className="min-h-[calc(100vh-4rem)] -mx-2 md:-mx-4">
            ...
            <section className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-600 text-white p-8 md:p-12">
                <div className="max-w-5xl">
                    ...
                    <div className="mt-6 flex flex-col sm:flex-row gap-3">
                        <Button size="lg" className="bg-white dark:bg-slate-800 text-blue-700 dark:text-blue-400 hover:bg-slate-100 dark:hover:bg-slate-700">
                            Apply Now
                        </Button>
            ...
            {/* Footer */}
            <footer id="contact" className="rounded-2xl border bg-white dark:bg-slate-800 p-6 mt-6">
                <div className="grid md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <p className="text-sm text-slate-600 dark:text-slate-300">Premier coaching for JEE, NEET and Foundation. Learn with discipline and mentorship.</p>
                    </div>
                    <div>
