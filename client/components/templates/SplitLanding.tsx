...
export default function SplitLanding({ brandName = "Your Institute" }: SplitLandingProps) {
    return (
        <div className="min-h-[calc(100vh-4rem)] -mx-2 md:-mx-4">
            {/* Header */}
            <section className="rounded-2xl border bg-white dark:bg-slate-800 p-4 mb-6">
                <div className="flex items-center justify-between gap-4">
                    ...
                    <nav className="hidden md:flex items-center gap-5 text-sm text-slate-600 dark:text-slate-300">
                        <a href="#programs" className="hover:text-slate-900 dark:hover:text-slate-100">Programs</a>
                        <a href="#why-us" className="hover:text-slate-900 dark:hover:text-slate-100">Why Us</a>
                        <a href="#testimonials" className="hover:text-slate-900 dark:hover:text-slate-100">Results</a>
                        <a href="#contact" className="hover:text-slate-900 dark:hover:text-slate-100">Contact</a>
                    </nav>
                    <div className="flex items-center gap-2">
            ...
            <section className="grid md:grid-cols-2 gap-6 items-stretch">
                <Card className="rounded-2xl overflow-hidden">
                    <CardContent className="p-6 md:p-8">
                        ...
                        <p className="mt-3 text-slate-600 dark:text-slate-300">Structured classes, adaptive tests and guided doubt-solving to help you stay consistent and improve week by week.</p>
            ...
            <section className="mt-6 rounded-2xl bg-slate-50 p-6">
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-slate-600 dark:text-slate-300">Experience our teaching style before you enroll.</p>
                    </div>
            ...
            {/* Footer */}
            <footer id="contact" className="rounded-2xl border bg-white dark:bg-slate-800 p-6">
                <div className="grid md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <p className="text-sm text-slate-600 dark:text-slate-300">Coaching for JEE, NEET and Boards with a focus on discipline and mentorship.</p>
                    </div>
                    <div>
