                        ...
                        {[
                            ...
                            <Card key={f.t} className="rounded-xl">
                                <CardContent className="p-4">
                                    <div className="h-10 w-10 rounded-lg bg-white dark:bg-slate-700 border flex items-center justify-center mb-3">
                                        <f.icon className="h-5 w-5 text-amber-600" />
                                    </div>
                                    <div className="font-medium">{f.t}</div>
                                    <div className="text-sm text-slate-600 dark:text-slate-300">{f.d}</div>
                                </CardContent>
                            </Card>
                        ))}
                    </div>
            ...
            <footer id="contact" className="rounded-2xl border bg-white dark:bg-slate-800 p-6">
                <div className="grid md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <p className="text-sm text-slate-600 dark:text-slate-300">Feature-first learning designed to maximize outcomes.</p>
                    </div>
                    <div>
