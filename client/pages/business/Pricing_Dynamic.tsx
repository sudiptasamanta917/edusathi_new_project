            ...
            <main className="container max-w-7xl mx-auto px-4 py-16">
                ...
                {plans.length === 0 ? (
                    <div className="text-center py-16">
                        <p className="text-xl text-slate-600 dark:text-slate-300">No pricing plans available at the moment.</p>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10 max-w-6xl mx-auto">
                        {plans.map((plan, index) => (
                            <Card
                                key={plan._id}
                                className={`group relative overflow-hidden rounded-2xl border border-slate-200/60 dark:border-slate-700/60 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 ${plan.isPopular
