        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
            <div className="mx-auto max-w-3xl px-4 py-8 space-y-6">
                <div className="flex items-center justify-between">
                    <h1 className="text-2xl md:text-3xl font-bold dark:text-slate-100">Account</h1>
                    ...
                    <CardContent>
                        <div className="space-y-3 text-sm">
                            <div>
                                ...
                                <span className="font-semibold dark:text-slate-100">{profile?.name || "N/A"}</span>
                            </div>
                            <div>
                                <span className="text-slate-600 dark:text-slate-300">Email: </span>
                                <span className="font-semibold dark:text-slate-100">{profile?.email || "N/A"}</span>
                            </div>
                            <div>
                                <span className="text-slate-600 dark:text-slate-300">Role: </span>
                                <span className="font-semibold dark:text-slate-100">{profile?.role || "N/A"}</span>
                            </div>
                        </div>
                    </CardContent>
                </Card>
