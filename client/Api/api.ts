...
export const ServicesAPI = {
  createService: (data: any) => apiPost<any>("/api/service/create", data),
  listServices: () => apiGet<any>("/api/service"),
  getServiceById: (id: string) => apiGet<any>(`/api/service/${id}`),
  stopService: (id: string) => apiPost<any>(`/api/service/${id}/stop`, {}),
  restartService: (id: string) => apiPost<any>(`/api/service/${id}/restart`, {}),
  deleteService: (id: string) => apiDelete<any>(`/api/service/${id}`),
  getServicesByBusinessId:(businessId:string)=> apiGet<any> (`/api/service/business/${businessId}`)
};
